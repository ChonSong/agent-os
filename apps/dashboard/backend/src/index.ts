...
async function runMigrations(): Promise<void> {
  ...
  try {
    const migrationFiles = ['001_initial.sql','002_observability_tables.sql','003_dashboard_sessions.sql','004_pg_cron_jobs.sql','005_skill_settings.sql','006_profiles_soul.sql','007_optimize_queries.sql'];
