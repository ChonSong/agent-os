...
const TASK_TEMPLATES: Omit<TaskTemplate, "installed" | "installed_job_id">[] = [
  ...
  },
  {
    ...
    icon: <SyncIcon />,
    category: "Development",
    description: "Check for updates to agent-os and Hermes dependencies",
  ...
  },
  {
    ...
    icon: <Zap />,
    category: "AI",
    description: "Review Hermes skill health, usage stats, and detect unused skills",
    prompt: "Audit the Hermes skills directory at /app/packages/nanobot/Hermes/skills/. For each skill: 1) Check if SKILL.md is present and complete, 2) Check last modified date, 3) Review the skill content for quality. Report any skills that are broken, incomplete, or haven't been used in 30+ days.",
    schedule_kind: "cron",
    schedule_expr: "0 4 * * 0",
    rating: 3.9,
  },
